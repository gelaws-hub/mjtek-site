...
export default function Unauthorized() {
  return (
    <div className="flex h-full w-[96%] flex-col items-center justify-center gap-12 py-8 ">
      <svg
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-center text-xl ">
          Anda mencoba mengakses halaman yang tidak dapat anda akses, silahkan kembali ke halaman sebelumnya atau
          <span><Link className="text-primary hover:underline" href="/">{" "}kembali ke Homepage</Link></span>
        </p>
      </div>
    </div>
  );
