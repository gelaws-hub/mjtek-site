...
export default function RedAlerts({
  ...
  return (
    <div className="fixed bottom-4 right-4 flex w-[30vw] border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[80%] dark:bg-opacity-90 px-7 py-8 shadow-md dark:bg-[#1B1B24] md:p-9">
      ...
      {onClose && (
        <button
          className="absolute top-4 right-4 text-[#B45454] hover:opacity-75"
          onClick={onClose}
